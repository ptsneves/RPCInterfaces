...
DroneSendVideoRequest = _reflection.GeneratedProtocolMessageType('DroneSendVideoRequest', (_message.Message,), {
...
DroneVideoState = _reflection.GeneratedProtocolMessageType('DroneVideoState', (_message.Message,), {
...
DroneFileList = _reflection.GeneratedProtocolMessageType('DroneFileList', (_message.Message,), {
...
_DRONE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='doReturnToHome',
    full_name='Drone.doReturnToHome',
    index=4,
    containing_service=None,
    input_type=_DRONEREQUEST,
    output_type=_DRONEREPLY,
