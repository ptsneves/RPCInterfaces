...
public partial class DroneFlyingState : TBase
{
  private FlyingState _state;
  private string _serial;
  private long _timestamp;

  /// <summary>
  /// 
  /// <seealso cref="FlyingState"/>
  /// </summary>
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          case 1:
            ...
            {
              State = (FlyingState)await iprot.ReadI32Async(cancellationToken);
            }
            else
            {
  ...
  public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
  {
    ...
    try
    {
      var struc = new TStruct("DroneFlyingState");
  ...
  {
    var other = that as DroneFlyingState;
  ...
  {
    var sb = new StringBuilder("DroneFlyingState(");
    bool __first = true;
    if (__isset.state)
    {
